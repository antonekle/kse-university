...
function UniAboutPage({ onNav, onCta }) {
  ...
  return (
    <div>
      ...
      >
        ...
        >
          ...
          <p
            style={{
              fontSize: 19,
              color: "var(--kse-desc-light)",
              marginTop: 18,
              maxWidth: "56ch",
              lineHeight: 1.55,
            }}
          >
            The University as a complete academic ecosystem: faculties,
            programs, research, people and community.
          </p>
        </div>
      </section>
        ...
        <div className="kse-shell">
          ...
          >
            <div>
              ...
              >
                KSE University is a research-intensive academic institution in
                Kyiv, Ukraine. It combines world-class education with applied
                research to train the economists, engineers, policy-makers and
                technologists who will shape Ukraine's future.
              </p>
              <p
                style={{
                  fontSize: 16,
              ...
              >
                The University operates five faculties, offers 21 degree
                programs at bachelor, master and doctoral level, and runs a
                portfolio of professional short courses and executive education.
                Research is embedded in every program — not separate from it.
              </p>
            </div>
            <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
              {/* Commented out the statistics cards block
              {[
          ...
          >
            {structure.map((s) => (
              <div
                ...
                onMouseEnter={(e) =>
                  (e.currentTarget.style.boxShadow = "var(--kse-shadow-md)")
                }
      ...
      <section className="usec">
        <div className="kse-shell">
          <h2 className="usec__title" style={{ marginBottom: 32 }}>
          ...
          >
            {links.map((l) => (
              <div
                ...
                onMouseEnter={(e) => {
                  e.currentTarget.style.background = "var(--kse-bg-light-2)";
                }}
                onMouseLeave={(e) => {
